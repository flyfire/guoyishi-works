...
// Date: 2010-01-26
// Coder: Yishi Guo
// Copy From: F:\CODE\LearningOpenCV_Code\ch10_motempl.cpp
/////////////////////////////////////////
...
void update_mhi( IplImage* img, IplImage* dst, int diff_threshold ) {
	...
	// segment is marked motion components map. It is not used further
	...
	for ( i = -1; i < seq->total; i++ ) {
		...
		if ( i < 0 ) {  // case of the whole image
			...
			if ( comp_rect.width + comp_rect.height < 100 )  // reject very small component
				continue;
		...
		angle = 360.0 - angle;  // adjust for images width top-left origin
